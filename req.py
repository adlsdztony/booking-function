...
class Booker:
    ...
    def login(self):
        try:
            ...
            logging.info(f'Login successful for {self.user["id"]}')
            return True
        except:
            logging.error(f'Login failed for {self.user["id"]}')
            return False
    ...
    def book(self):
        ...
        if 'Your Booking is successful' in r.text:
            logging.info(f'Booking successful for {self.user["id"]}')
            return True
        else:
            logging.error(f'Booking failed for {self.user["id"]}')
            return False
